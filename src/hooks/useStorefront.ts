...
const storefrontTranslations: Record<StorefrontLanguage, TranslationMap> = {
  'pt-BR': {
    ...
    createAccountSubmitting: 'Criando conta...',
    newsletterSuccess: 'Inscricao confirmada! Use o cupom {coupon} na sua primeira compra.',
    newsletterError: 'Nao foi possivel concluir seu cadastro agora.',
    newsletterBenefitAvailable: 'Sua conta liberou {discount}% de desconto de boas-vindas. Use o codigo {coupon}.',
    newsletterBenefitApplied: 'Desconto de boas-vindas aplicado com sucesso.',
    newsletterBenefitLoginRequired: 'Entre na sua conta para usar o desconto de boas-vindas.',
    newsletterBenefitUnavailable: 'Nenhum desconto de boas-vindas esta disponivel para esta conta.',
    applyWelcomeDiscount: 'Aplicar desconto',
    removeDiscount: 'Remover desconto',
    welcomeDiscountRemoved: 'Desconto de boas-vindas removido.',
    ...
    checkoutWelcomeDiscountApplied: 'Inclui {discount} de desconto de boas-vindas nesta compra.',
  ...
  'en-US': {
    ...
    newsletterSuccess: 'Subscription confirmed! Use coupon {coupon} on your first order.',
    newsletterError: 'We could not complete your sign-up right now.',
    newsletterBenefitAvailable: 'Your account unlocked a {discount}% welcome discount. Use code {coupon}.',
    newsletterBenefitApplied: 'Welcome discount applied successfully.',
    newsletterBenefitLoginRequired: 'Sign in to your account to use the welcome discount.',
    newsletterBenefitUnavailable: 'No welcome discount is available for this account.',
    applyWelcomeDiscount: 'Apply discount',
    removeDiscount: 'Remove discount',
    welcomeDiscountRemoved: 'Welcome discount removed.',
    ...
    checkoutWelcomeDiscountApplied: 'Includes {discount} of welcome discount on this purchase.',
