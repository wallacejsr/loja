CREATE TABLE IF NOT EXISTS products (
  ...
  fabric_weight VARCHAR(120) NOT NULL DEFAULT '',
  features LONGTEXT NULL,
  care_instructions LONGTEXT NULL,
...
ALTER TABLE products
  ADD COLUMN IF NOT EXISTS fabric_weight VARCHAR(120) NOT NULL DEFAULT '';

ALTER TABLE products
  ADD COLUMN IF NOT EXISTS features LONGTEXT NULL;

ALTER TABLE products
  ADD COLUMN IF NOT EXISTS care_instructions LONGTEXT NULL;
